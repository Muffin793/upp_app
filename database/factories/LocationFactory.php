...
$state = $this->faker->randomElement(array_keys($mexicoCities));

// Seleccionar una ciudad aleatoria del arreglo asociado al estado
$city = $this->faker->randomElement($mexicoCities[$state]);

         $latitude = $this->faker->latitude($min = -90, $max = 90);
         $longitude = $this->faker->longitude($min = -180, $max = 180);
 
         // Concatenar las coordenadas en un solo campo
